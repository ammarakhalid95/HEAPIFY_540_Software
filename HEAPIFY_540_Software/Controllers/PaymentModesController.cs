...
namespace HEAPIFY_540_Software.Controllers
{
    ...
    public class PaymentModesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentModeID,PaymentModeType")] PaymentMode paymentMode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentModeID,PaymentModeType")] PaymentMode paymentMode)
        {
            if (ModelState.IsValid)
            {
